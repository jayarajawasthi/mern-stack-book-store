    ...
    <div className="p-4">
      <div className="flex justify-between items-center">
        ...
        <Link to="/books/create">
          <MdOutlineAddBox className="text-sky-800 textt-4xl" />
        </Link>
      </div>
      {loading ? (
        <Spinner />
        ...
        <table className="w-full border-separate border-spacing-2">
          <thead>
            <tr>
              ...
              <th className="boder border-slate-600 rounded-md max-md:hidden">
                Author
              </th>
              <th className="boder border-slate-600 rounded-md max-md:hidden">
                Publish Year
          ...
          <tbody>
            {books.map((book, index) => (
              <tr key={book._id} className="h-8">
                <td className="border border-slate-7 rounded-md text-center">
                  {index + 1}
                </td>
